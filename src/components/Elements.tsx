...
import ProjectListShowcase from '@/elements/ProjectListShowcase'; // Added import
...
export default function FloatingMenuShowcase({ align = 'right' }: FloatingMenuProps) {
    ...
    },
    {
        name: 'Orb',
        component: (
            <UnicornStudioWrapper link='https://www.unicorn.studio/embed/cZhzls90muLE1G6dvt0w' />
        ),
        code: ``,
        day: 94
    },
